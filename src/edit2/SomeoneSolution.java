...
class SomeoneSolution {
	...
	public static void main(String[] args) {
		...
		SomeoneSolution some = new SomeoneSolution();
		long time1 = System.currentTimeMillis();
		int x = some.divide(-1010369383, -2147483648);
	...
	public int divide(int dividend, int divisor) {
		// The answer will be negative if either the dividend or divisor is negative,
		// but not both
		...
		// If the divident is -2147483648, we need to move it closer to 0, so it'll fit
		// in the positive range of an int
